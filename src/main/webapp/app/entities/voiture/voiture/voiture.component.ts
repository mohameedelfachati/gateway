...
export class VoitureComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.voitureService
      ...
      .subscribe(
        (res: HttpResponse<IVoiture[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IVoiture[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
