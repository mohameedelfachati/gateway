package com.cm.gateway.repository;

import com.cm.gateway.GatewayApp;

import com.cm.gateway.config.Constants;
import com.cm.gateway.config.audit.AuditEventConverter;
import com.cm.gateway.domain.PersistentAuditEvent;
...
import static com.cm.gateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
